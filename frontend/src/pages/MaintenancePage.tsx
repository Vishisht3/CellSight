...
const JOBS: MaintenanceJob[] = [
  ...
  { id:'j8',  assetId:'a8', assetName:'Riverton Linehaul 117', jobType:'Thermal Event Follow-up',           priority:'High',     scheduledDate:'2026-07-24', estimatedHours:3, technicianSlot:'Tech B  -  Bay 1', status:'Upcoming',  description:'Post-event inspection following 52Â°C excursion logged 2026-07-20. Coolant, sensors, BMS log review.',     chargingImpact:true,  shift:'Day'   },
