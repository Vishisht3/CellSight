...
// ── Synthetic maintenance schedule data ──────────────────────────────────────
...
const JOBS: MaintenanceJob[] = [
  { id:'j1',  assetId:'a1', assetName:'FreightLiner-001', jobType:'Battery Thermal System Inspection', priority:'Critical', scheduledDate:'2026-07-22', estimatedHours:3, technicianSlot:'Tech A — Bay 2', status:'Due Today',  description:'Coolant loop pressure check, pump inspection, thermal sensor calibration. Flagged by thermal event alert.',    chargingImpact:true,  shift:'Day'   },
  { id:'j2',  assetId:'a2', assetName:'Haul-Truck-A1',   jobType:'SoH Diagnostic & Cell Balancing',  priority:'High',     scheduledDate:'2026-07-22', estimatedHours:4, technicianSlot:'Tech B — Bay 1', status:'Due Today',  description:'SoH below 82%. Full diagnostic, BMS recalibration, passive cell balancing cycle.',                         chargingImpact:true,  shift:'Day'   },
  { id:'j3',  assetId:'a3', assetName:'Excavator-EX1',   jobType:'Predictive: Charge Pattern Review', priority:'Medium',   scheduledDate:'2026-07-22', estimatedHours:1, technicianSlot:'Tech C — Bay 3', status:'In Progress',description:'Software update to restrict charging to 20–80% SoC window as recommended by APM agent.',                  chargingImpact:false, shift:'Day'   },
  { id:'j4',  assetId:'a4', assetName:'FreightLiner-003', jobType:'Routine 500-Cycle Service',         priority:'Low',      scheduledDate:'2026-07-23', estimatedHours:2, technicianSlot:'Tech A — Bay 2', status:'Upcoming',  description:'Standard 500-cycle inspection: contact cleaning, connector torque check, firmware update.',                chargingImpact:false, shift:'Any'   },
  { id:'j5',  assetId:'a5', assetName:'Forklift-FL05',    jobType:'RUL Threshold — Battery Swap Prep', priority:'Critical', scheduledDate:'2026-07-23', estimatedHours:6, technicianSlot:'Tech B — Bay 1', status:'Upcoming',  description:'Remaining Useful Life ≤ 7 days. Prepare replacement pack PACK-GCM-003, schedule swap window.',             chargingImpact:true,  shift:'Night' },
  { id:'j6',  assetId:'a6', assetName:'Haul-Truck-B1',   jobType:'Charging Infrastructure Check',     priority:'Medium',   scheduledDate:'2026-07-24', estimatedHours:2, technicianSlot:'Tech C — Bay 3', status:'Upcoming',  description:'Verify 150 kW charge point calibration, connector wear, load-balancing relay test.',                        chargingImpact:true,  shift:'Day'   },
  { id:'j7',  assetId:'a7', assetName:'Forklift-FL01',    jobType:'Routine 500-Cycle Service',         priority:'Low',      scheduledDate:'2026-07-21', estimatedHours:2, technicianSlot:'Tech A — Bay 2', status:'Overdue',   description:'Service window missed. Rescheduled — contact cleaning and connector torque overdue.',                      chargingImpact:false, shift:'Any'   },
  { id:'j8',  assetId:'a8', assetName:'FreightLiner-002', jobType:'Thermal Event Follow-up',           priority:'High',     scheduledDate:'2026-07-24', estimatedHours:3, technicianSlot:'Tech B — Bay 1', status:'Upcoming',  description:'Post-event inspection following 52°C excursion logged 2026-07-20. Coolant, sensors, BMS log review.',     chargingImpact:true,  shift:'Day'   },
  { id:'j9',  assetId:'a9', assetName:'Loader-LD1',       jobType:'Annual Safety Certification',       priority:'High',     scheduledDate:'2026-07-25', estimatedHours:4, technicianSlot:'Tech A — Bay 2', status:'Upcoming',  description:'Annual statutory inspection required by HSE. Includes insulation resistance test, earth bonding verification.',chargingImpact:false, shift:'Day'   },
  { id:'j10', assetId:'a10',assetName:'Mining-Vehicle-C1',jobType:'SoH Diagnostic',                   priority:'Medium',   scheduledDate:'2026-07-26', estimatedHours:3, technicianSlot:'Tech C — Bay 3', status:'Upcoming',  description:'Routine SoH diagnostic at 350 cycles. Compare against degradation baseline.',                             chargingImpact:true,  shift:'Any'   },
];
              ...
              {CAPACITY.map(c => {
                ...
                return (
                  <tr key={c.shift}>
                    ...
                    <td style={{ fontFamily: 'Courier New,monospace' }}>{c.start}–{c.end}</td>
                    <td>
                  ...
                  {displayed.map(j => (
                    ...
                    >
                      ...
                      <td style={{ textAlign: 'center' }}>
                        {j.chargingImpact
                          ? <span style={{ color: '#b87000', fontWeight: 'bold', fontSize: 12 }}>⚡</span>
